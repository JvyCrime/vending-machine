...
class URangesKt___URangesKt {
    ...
    private static final boolean m1258containsbiwQdVI(UIntRange contains, UInt uInt) {
        ...
        return uInt != null && contains.m1230containsWZ4Q5Ns(uInt.getData());
    }
    ...
    private static final boolean m1254containsGYNo2lE(ULongRange contains, ULong uLong) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return uLong != null && contains.m1236containsVKZWuLQ(uLong.getData());
    }
    ...
    public static final boolean m1253contains68kG9v0(UIntRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1230containsWZ4Q5Ns(UInt.m116constructorimpl(b & 255));
    }
    ...
    public static final boolean m1256containsULbyJY(ULongRange contains, byte b) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1236containsVKZWuLQ(ULong.m194constructorimpl(((long) b) & 255));
    }
    ...
    public static final boolean m1255containsGab390E(ULongRange contains, int i) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1236containsVKZWuLQ(ULong.m194constructorimpl(((long) i) & 4294967295L));
    }
    ...
    public static final boolean m1260containsuhHAxoY(ULongRange contains, short s) {
        Intrinsics.checkNotNullParameter(contains, "$this$contains");
        return contains.m1236containsVKZWuLQ(ULong.m194constructorimpl(((long) s) & 65535));
    }
    ...
    public static final UIntProgression m1263downToKr8caGY(byte b, byte b2) {
        return UIntProgression.INSTANCE.m1229fromClosedRangeNkh28Cs(UInt.m116constructorimpl(b & 255), UInt.m116constructorimpl(b2 & 255), -1);
    }
    ...
    public static final UIntProgression m1262downToJ1ME1BU(int i, int i2) {
        return UIntProgression.INSTANCE.m1229fromClosedRangeNkh28Cs(i, i2, -1);
    }
    ...
    public static final ULongProgression m1264downToeb3DHEI(long j, long j2) {
        return ULongProgression.INSTANCE.m1235fromClosedRange7ftBX0g(j, j2, -1L);
    }
    ...
    public static final UIntProgression m1261downTo5PvTz6A(short s, short s2) {
        return UIntProgression.INSTANCE.m1229fromClosedRangeNkh28Cs(UInt.m116constructorimpl(s & UShort.MAX_VALUE), UInt.m116constructorimpl(s2 & UShort.MAX_VALUE), -1);
    }

    public static final UIntProgression reversed(UIntProgression reversed) {
        Intrinsics.checkNotNullParameter(reversed, "$this$reversed");
        return UIntProgression.INSTANCE.m1229fromClosedRangeNkh28Cs(reversed.getLast(), reversed.getFirst(), -reversed.getStep());
    }

    public static final ULongProgression reversed(ULongProgression reversed) {
        Intrinsics.checkNotNullParameter(reversed, "$this$reversed");
        return ULongProgression.INSTANCE.m1235fromClosedRange7ftBX0g(reversed.getLast(), reversed.getFirst(), -reversed.getStep());
    }
    ...
    public static final UIntProgression step(UIntProgression step, int i) {
        ...
        return companion.m1229fromClosedRangeNkh28Cs(first, last, i);
    }
    ...
    public static final ULongProgression step(ULongProgression step, long j) {
        ...
        return companion.m1235fromClosedRange7ftBX0g(first, last, j);
    }
    ...
    public static final UIntRange m1267untilKr8caGY(byte b, byte b2) {
        return Intrinsics.compare(b2 & 255, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m116constructorimpl(b & 255), UInt.m116constructorimpl(UInt.m116constructorimpl(r3) - 1), null);
    }
    ...
    public static final UIntRange m1266untilJ1ME1BU(int i, int i2) {
        return UnsignedKt.uintCompare(i2, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(i, UInt.m116constructorimpl(i2 - 1), null);
    }
    ...
    public static final ULongRange m1268untileb3DHEI(long j, long j2) {
        return UnsignedKt.ulongCompare(j2, 0L) <= 0 ? ULongRange.INSTANCE.getEMPTY() : new ULongRange(j, ULong.m194constructorimpl(j2 - ULong.m194constructorimpl(((long) 1) & 4294967295L)), null);
    }
    ...
    public static final UIntRange m1265until5PvTz6A(short s, short s2) {
        return Intrinsics.compare(s2 & UShort.MAX_VALUE, 0) <= 0 ? UIntRange.INSTANCE.getEMPTY() : new UIntRange(UInt.m116constructorimpl(s & UShort.MAX_VALUE), UInt.m116constructorimpl(UInt.m116constructorimpl(r3) - 1), null);
    }
    ...
    public static final int m1252coerceInwuiCnnA(int i, ClosedRange<UInt> range) {
        ...
        if (range instanceof ClosedFloatingPointRange) {
            return ((UInt) RangesKt.coerceIn(UInt.m110boximpl(i), (ClosedFloatingPointRange<UInt>) range)).getData();
        }
        if (!range.isEmpty()) {
    ...
    public static final long m1247coerceInJPwROB0(long j, ClosedRange<ULong> range) {
        Intrinsics.checkNotNullParameter(range, "range");
        if (range instanceof ClosedFloatingPointRange) {
            return ((ULong) RangesKt.coerceIn(ULong.m188boximpl(j), (ClosedFloatingPointRange<ULong>) range)).getData();
        }
        if (!range.isEmpty()) {
