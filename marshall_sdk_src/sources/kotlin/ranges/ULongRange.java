...
public final class ULongRange extends ULongProgression implements ClosedRange<ULong> {
    ...
    public /* bridge */ /* synthetic */ boolean contains(Comparable comparable) {
        return m1236containsVKZWuLQ(((ULong) comparable).getData());
    }
    ...
    public boolean m1236containsVKZWuLQ(long value) {
    ...
    public int hashCode() {
        ...
        return ((int) ULong.m194constructorimpl(getLast() ^ ULong.m194constructorimpl(getLast() >>> 32))) + (((int) ULong.m194constructorimpl(getFirst() ^ ULong.m194constructorimpl(getFirst() >>> 32))) * 31);
    }

    @Override // kotlin.ranges.ULongProgression
    public String toString() {
        return ULong.m239toStringimpl(getFirst()) + ".." + ULong.m239toStringimpl(getLast());
    }
