...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM194constructorimpl = ((int) ULong.m194constructorimpl(j ^ ULong.m194constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM194constructorimpl2 = (iM194constructorimpl + ((int) ULong.m194constructorimpl(j2 ^ ULong.m194constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return ((int) (j3 ^ (j3 >>> 32))) + iM194constructorimpl2;
    }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m1235fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
