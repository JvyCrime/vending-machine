...
public final class UStringsKt {
    ...
    public static final UByte toUByteOrNull(String toUByteOrNull, int i) {
        ...
        if (UnsignedKt.uintCompare(data, UInt.m116constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m34boximpl(UByte.m40constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String toUShortOrNull, int i) {
        ...
        int data = uIntOrNull.getData();
        if (UnsignedKt.uintCompare(data, UInt.m116constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m294boximpl(UShort.m300constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String toUIntOrNull, int i) {
        ...
        int iM116constructorimpl = UInt.m116constructorimpl(i);
        int iM369uintDivideJ1ME1BU = 119304647;
        while (i3 < length) {
            int iDigitOf = CharsKt.digitOf(toUIntOrNull.charAt(i3), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (UnsignedKt.uintCompare(i2, iM369uintDivideJ1ME1BU) > 0) {
                if (iM369uintDivideJ1ME1BU == 119304647) {
                    iM369uintDivideJ1ME1BU = UnsignedKt.m369uintDivideJ1ME1BU(-1, iM116constructorimpl);
                    if (UnsignedKt.uintCompare(i2, iM369uintDivideJ1ME1BU) > 0) {
                    }
                }
                return null;
            }
            int iM116constructorimpl2 = UInt.m116constructorimpl(i2 * iM116constructorimpl);
            int iM116constructorimpl3 = UInt.m116constructorimpl(UInt.m116constructorimpl(iDigitOf) + iM116constructorimpl2);
            if (UnsignedKt.uintCompare(iM116constructorimpl3, iM116constructorimpl2) < 0) {
                return null;
            }
            i3++;
            i2 = iM116constructorimpl3;
        }
    ...
    public static final ULong toULongOrNull(String toULongOrNull, int i) {
        ...
        long jM194constructorimpl = ULong.m194constructorimpl(i);
        long j2 = 0;
        long jM371ulongDivideeb3DHEI = 512409557603043100L;
        while (i2 < length) {
            int iDigitOf = CharsKt.digitOf(toULongOrNull.charAt(i2), i);
            if (iDigitOf < 0) {
                return null;
            }
            if (UnsignedKt.ulongCompare(j2, jM371ulongDivideeb3DHEI) > 0) {
                if (jM371ulongDivideeb3DHEI == 512409557603043100L) {
                    jM371ulongDivideeb3DHEI = UnsignedKt.m371ulongDivideeb3DHEI(j, jM194constructorimpl);
                    if (UnsignedKt.ulongCompare(j2, jM371ulongDivideeb3DHEI) > 0) {
                    }
                }
                return null;
            }
            long jM194constructorimpl2 = ULong.m194constructorimpl(j2 * jM194constructorimpl);
            long jM194constructorimpl3 = ULong.m194constructorimpl(ULong.m194constructorimpl(((long) UInt.m116constructorimpl(iDigitOf)) & 4294967295L) + jM194constructorimpl2);
            if (UnsignedKt.ulongCompare(jM194constructorimpl3, jM194constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j2 = jM194constructorimpl3;
            j = -1;
        }
