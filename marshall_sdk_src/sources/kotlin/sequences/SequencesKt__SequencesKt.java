...
public class SequencesKt__SequencesKt extends SequencesKt__SequencesJVMKt {
    ...
    static final class C00711<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        C00711(Sequence sequence, Function0 function0, Continuation continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            ...
            C00711 c00711 = new C00711(this.$this_ifEmpty, this.$defaultValue, completion);
            c00711.L$0 = obj;
            return c00711;
        }
        ...
        public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return ((C00711) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Sequence<T> ifEmpty(Sequence<? extends T> ifEmpty, Function0<? extends Sequence<? extends T>> defaultValue) {
        ...
        return SequencesKt.sequence(new C00711(ifEmpty, defaultValue, null));
    }
    ...
    static final class C00721<T> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super T>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00721(Sequence sequence, Random random, Continuation continuation) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            Intrinsics.checkNotNullParameter(completion, "completion");
            C00721 c00721 = new C00721(this.$this_shuffled, this.$random, completion);
            c00721.L$0 = obj;
            return c00721;
        }
    ...
    public static final <T> Sequence<T> shuffled(Sequence<? extends T> shuffled, Random random) {
        ...
        return SequencesKt.sequence(new C00721(shuffled, random, null));
    }
    ...
    static final class C00671<R> extends RestrictedSuspendLambda implements Function2<SequenceScope<? super R>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00671(Sequence sequence, Function2 function2, Function1 function1, Continuation continuation) {
            super(2, continuation);
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> completion) {
            Intrinsics.checkNotNullParameter(completion, "completion");
            C00671 c00671 = new C00671(this.$source, this.$transform, this.$iterator, completion);
            c00671.L$0 = obj;
            return c00671;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Object obj, Continuation<? super Unit> continuation) {
            return ((C00671) create(obj, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, C, R> Sequence<R> flatMapIndexed(Sequence<? extends T> source, Function2<? super Integer, ? super T, ? extends C> transform, Function1<? super C, ? extends Iterator<? extends R>> iterator) {
        ...
        return SequencesKt.sequence(new C00671(source, transform, iterator, null));
    }
