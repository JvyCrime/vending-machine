...
final class s extends AbstractC0028i {
    ...
    private static final void a(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 0;
        int i5 = i2 + 0;
        int i6 = i2 + 1;
        int i7 = 32 - i;
    ...
    private static final void b(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 2;
        int i5 = i2 + 0;
        int i6 = i2 + 1;
        int i7 = 32 - i;
    ...
    private final void b(int[] iArr, int[] iArr2, int i) {
        iArr[1] = iArr[1] ^ c(iArr[0] & iArr2[i + 0], 1);
        iArr[0] = iArr[0] ^ (iArr2[i + 1] | iArr[1]);
        iArr[2] = iArr[2] ^ (iArr2[i + 3] | iArr[3]);
        iArr[3] = c(iArr2[i + 2] & iArr[2], 1) ^ iArr[3];
    }
    ...
    private static final void c(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 0;
        int i5 = i2 + 1;
        int i6 = i - 32;
        int i7 = i2 + 2;
    ...
    private static final void d(int i, int[] iArr, int i2, int[] iArr2, int i3) {
        int i4 = i3 + 2;
        int i5 = i2 + 1;
        int i6 = i - 32;
        int i7 = i2 + 2;
    ...
    private final void j() {
        ...
        a(this.o, this.c, 28);
        a(this.o, this.c, 32);
        this.a[0] = this.m[4] ^ this.o[2];
        this.a[1] = this.o[3] ^ this.m[5];
        this.a[2] = this.o[0] ^ this.m[6];
        this.a[3] = this.o[1] ^ this.m[7];
    }
    ...
    @Override // iaik.security.cipher.AbstractC0028i, iaik.security.cipher.t
    void a() {
        super.a();
        System.arraycopy(this.p, 0, this.c, 0, 96);
        System.arraycopy(this.q, 0, this.n, 0, 12);
        System.arraycopy(this.r, 0, this.o, 0, 4);
    }
    ...
    protected void a(int i, byte[] bArr) {
        ...
        if (length != 16) {
            if (length == 24) {
                CryptoUtils.squashBytesToInts(bArr, 0, iArr, 0, 6);
                iArr[6] = ~iArr[4];
                iArr[7] = ~iArr[5];
            } else {
                if (length != 32) {
                ...
                CryptoUtils.squashBytesToInts(bArr, 0, iArr, 0, 8);
            }
            this.b = false;
        } else {
            this.b = true;
            CryptoUtils.squashBytesToInts(bArr, 0, iArr, 0, 4);
            iArr[7] = 0;
            iArr[6] = 0;
            iArr[5] = 0;
            iArr[4] = 0;
        ...
        if (!this.b) {
            ...
            if (i == 1) {
                ...
                iArr7[2] = iArr3[2];
                iArr7[3] = iArr3[3];
                a(30, iArr3, 0, iArr7, 12);
                a(30, iArr3, 0, this.c, 28);
                c(51, iArr3, 0, this.m, 4);
            } else {
                int[] iArr8 = this.m;
                iArr8[4] = iArr[0];
                iArr8[5] = iArr[1];
                ...
                iArr10[44] = iArr3[2];
                iArr10[45] = iArr3[3];
                b(30, iArr3, 0, iArr10, 32);
                b(30, iArr3, 0, this.c, 16);
                c(51, iArr3, 0, this.m, 0);
            }
        } else if (i == 1) {
            int[] iArr11 = this.m;
            iArr11[0] = iArr[0];
            ...
            iArr13[2] = iArr2[2];
            iArr13[3] = iArr2[3];
            a(15, iArr2, 0, iArr13, 8);
            a(15, iArr2, 0, this.n, 0);
            a(15, iArr2, 0, iArr4, 0);
            int[] iArr14 = this.c;
            iArr14[16] = iArr4[0];
            iArr14[17] = iArr4[1];
            a(15, iArr2, 0, iArr14, 20);
            c(34, iArr2, 0, this.c, 28);
            a(17, iArr2, 0, this.m, 4);
        } else {
            int[] iArr15 = this.m;
            iArr15[4] = iArr[0];
            iArr15[5] = iArr[1];
            ...
            iArr17[32] = iArr2[2];
            iArr17[33] = iArr2[3];
            b(15, iArr2, 0, iArr17, 24);
            b(15, iArr2, 0, this.n, 4);
            b(15, iArr2, 0, iArr4, 0);
            int[] iArr18 = this.c;
            iArr18[18] = iArr4[2];
            iArr18[19] = iArr4[3];
            b(15, iArr2, 0, iArr18, 12);
            d(34, iArr2, 0, this.c, 4);
            a(17, iArr2, 0, this.m, 0);
        }
        System.arraycopy(this.c, 0, this.p, 0, 96);
        System.arraycopy(this.n, 0, this.q, 0, 12);
        System.arraycopy(this.o, 0, this.r, 0, 4);
    }
