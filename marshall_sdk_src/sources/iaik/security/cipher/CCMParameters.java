...
public class CCMParameters extends AlgorithmParametersSpi {
    private byte[] a;
    private int b;
    private byte[] c;
    ...
    public CCMParameters(byte[] bArr, byte[] bArr2, int i) throws InvalidAlgorithmParameterException {
        this.a = bArr2;
        this.b = i;
        this.c = bArr;
        i = i == -1 ? 12 : i;
    ...
    protected AlgorithmParameterSpec engineGetParameterSpec(Class cls) throws InvalidParameterSpecException {
        try {
            CCMParameterSpec cCMParameterSpec = new CCMParameterSpec(-1L, this.c, this.a, this.b);
            if (cCMParameterSpec.getClass().isAssignableFrom(cls)) {
