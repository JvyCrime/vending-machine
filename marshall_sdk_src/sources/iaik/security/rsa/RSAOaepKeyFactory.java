...
public final class RSAOaepKeyFactory extends KeyFactorySpi {
    static Class a;
    static Class b;
    ...
    protected PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        try {
            if (keySpec instanceof PKCS8EncodedKeySpec) {
                return new RSAOaepPrivateKey(((PKCS8EncodedKeySpec) keySpec).getEncoded());
            }
    ...
    protected PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        try {
            if (keySpec instanceof X509EncodedKeySpec) {
                return new RSAOaepPublicKey(((X509EncodedKeySpec) keySpec).getEncoded());
            }
    ...
    protected KeySpec engineGetKeySpec(Key key, Class cls) throws InvalidKeySpecException {
        if (key instanceof RSAOaepPublicKey) {
            Class clsClass$ = a;
            if (clsClass$ == null) {
        ...
        if (!(key instanceof RSAOaepPrivateKey)) {
    ...
    protected Key engineTranslateKey(Key key) throws InvalidKeyException {
        if (key instanceof java.security.interfaces.RSAPublicKey) {
            return new RSAOaepPublicKey(key.getEncoded());
        }
        if (key instanceof java.security.interfaces.RSAPrivateKey) {
            return new RSAOaepPrivateKey(key.getEncoded());
        }
