...
public class ProxyInfo extends V3Extension {
    ...
    public boolean checkProxy(Object obj, Object obj2) throws TargetException {
        if (obj instanceof Holder) {
            ...
            Objects.requireNonNull(holder, "Cannot verify sender identity since AC holder not specified!");
            if (!holder.equals(obj)) {
                return false;
            }
            if (this.a.size() != 0 && getTargets(obj2) == null) {
                return false;
            }
    ...
    public boolean checkProxyChain(Target[] targetArr) throws TargetException {
        Objects.requireNonNull(targetArr, "Cannot check null array of Target elements.");
    ...
    public Targets getTargets(Object obj) throws TargetException {
        ...
        if (this.a.size() > 0) {
            ...
            while (true) {
                ...
                Targets targets2 = (Targets) enumerationElements.nextElement();
                try {
    ...
    public String toString(boolean z) {
        ...
        StringBuffer stringBuffer = new StringBuffer();
        if (this.a.isEmpty()) {
            string = "This ProxyInfo does not contain any Targets.";
        } else {
            ...
            stringBuffer4.append("This ProxyInfo contains ");
