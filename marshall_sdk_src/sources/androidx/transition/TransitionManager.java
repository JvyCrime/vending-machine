...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo8clone = transition.mo8clone();
        transitionMo8clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo8clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo8clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo8clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo8clone = transition.mo8clone();
        sceneChangeSetup(viewGroup, transitionMo8clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo8clone);
    }
