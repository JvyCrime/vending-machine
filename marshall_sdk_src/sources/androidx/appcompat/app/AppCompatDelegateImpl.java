    ...
    */
    ...
    private static Configuration generateConfigDelta(Configuration configuration, Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            if ((configuration.screenLayout & SSLContext.VERSION_SSL30) != (configuration2.screenLayout & SSLContext.VERSION_SSL30)) {
                configuration3.screenLayout |= configuration2.screenLayout & SSLContext.VERSION_SSL30;
            }
            if (Build.VERSION.SDK_INT >= 26) {
