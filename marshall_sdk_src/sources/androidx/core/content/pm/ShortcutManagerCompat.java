...
public class ShortcutManagerCompat {
    ...
    public static boolean requestPinShortcut(final Context context, ShortcutInfoCompat shortcut, final IntentSender callback) throws IllegalAccessException, NoSuchMethodException, PackageManager.NameNotFoundException, InvocationTargetException {
        if (Build.VERSION.SDK_INT >= 26) {
