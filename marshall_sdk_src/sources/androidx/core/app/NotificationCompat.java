...
public class NotificationCompat {
    ...
    public static abstract class Style {
        ...
        */
        ...
        private Bitmap createColoredBitmap(IconCompat icon, int color, int size) throws IllegalAccessException, NoSuchMethodException, PackageManager.NameNotFoundException, InvocationTargetException {
