    ...
    void buildBounds(float[] bounds, int pointCount) {
        ...
        for (int i = 0; i < pointCount; i++) {
            ...
            if (easing != null) {
                ...
                d = (((float) easing.get((fMin - f3) / r9)) * (f5 - f3)) + f3;
            }
        ...
        while (true) {
            ...
            while (i14 < size) {
                if (motionPathsArr[i14].hasCustomData(str10)) {
                    ...
                    motionPathsArr[i14].getCustomData(str10, dArr3[i15], 0);
                    i15++;
                }
                i14++;
                i = 2;
            ...
            i13++;
            this.mSpline[i13] = CurveFit.get(this.mCurveFitType, Arrays.copyOf(dArr4, i15), (double[][]) Arrays.copyOf(dArr3, i15));
            i = 2;
            c = 0;
        }
