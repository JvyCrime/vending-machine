    ...
    public static void interpolate(int i, int i2, WidgetFrame widgetFrame, WidgetFrame widgetFrame2, WidgetFrame widgetFrame3, Transition transition, float f) {
        ...
        if (widgetFrame.widget == null || !transition.hasPositionKeyframes()) {
            ...
            if (keyPositionFindNextPosition != null) {
                int i19 = (int) (keyPositionFindNextPosition.x * i6);
                int i20 = (int) (keyPositionFindNextPosition.y * i7);
        ...
        int i21 = (int) (i5 + ((i13 - r9) * f5));
        widgetFrame.left = i21;
        int i22 = (int) (i12 + (f5 * (i14 - i12)));
        widgetFrame.top = i22;
        float f10 = 1.0f - f;
        widgetFrame.right = i21 + ((int) ((i3 * f10) + (i17 * f)));
        widgetFrame.bottom = i22 + ((int) ((f10 * i4) + (i18 * f)));
