...
class MTHIDReportParser {
    ...
    private void parseMainItem(Item item) {
        int i = AnonymousClass1.$SwitchMap$com$magtek$mobile$android$mtlib$MTHIDReportParser$MainTag[item.m_MTag.ordinal()];
        if (i == 1) {
    ...
    public void parse(byte[] bArr, int i) {
        ...
        while (true) {
            ...
            if (nextItem != null) {
                int i2 = AnonymousClass1.$SwitchMap$com$magtek$mobile$android$mtlib$MTHIDReportParser$ItemType[nextItem.m_Type.ordinal()];
                if (i2 == 1) {
    ...
    /* JADX INFO: renamed from: com.magtek.mobile.android.mtlib.MTHIDReportParser$1, reason: invalid class name */
