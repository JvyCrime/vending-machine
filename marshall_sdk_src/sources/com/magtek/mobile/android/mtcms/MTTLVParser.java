...
public class MTTLVParser {
    ...
    public static MTTLVObject findFromListByTagByteArray(List<MTTLVObject> list, byte[] bArr) {
        MTTLVObject mTTLVObjectFindByTagByteArray = null;
        if (list != null) {
            for (int i = 0; i < list.size(); i++) {
                MTTLVObject mTTLVObject = list.get(i);
    ...
    */
    public static java.util.List<com.magtek.mobile.android.mtcms.MTTLVObject> parseTLVByteArray(byte[] r10, boolean r11) {
        /*
        ...
        L19:
            ...
            int r4 = r4 + 1
            if (r7 != 0) goto L30
            byte r8 = com.magtek.mobile.android.mtcms.MTTLVParser.MoreTagBytesFlag1
            r6 = r6 & r8
            if (r6 != r8) goto L2e
        L2c:
            r6 = 1
        ...
        L2e:
            ...
            goto L36
        L30:
            byte r8 = com.magtek.mobile.android.mtcms.MTTLVParser.MoreTagBytesFlag2
            r6 = r6 & r8
            if (r6 != r8) goto L2e
            goto L2c
        L36:
        ...
        L3f:
            r5 = r10[r4]
            byte r7 = com.magtek.mobile.android.mtcms.MTTLVParser.MultiByteLengthFlag
            r8 = r5 & r7
            if (r8 != r7) goto L5f
            byte r7 = com.magtek.mobile.android.mtcms.MTTLVParser.OneByteLengthMask
            r5 = r5 & r7
            int r4 = r4 + 1
            r7 = 0
            r8 = 0
        ...
        L79:
            ...
            if (r7 == 0) goto La6
            if (r11 == 0) goto La6
            com.magtek.mobile.android.mtcms.MTTLVObject r7 = new com.magtek.mobile.android.mtcms.MTTLVObject
            r7.<init>(r6)
            if (r5 == 0) goto La1
            java.util.List r5 = parseTLVByteArray(r5, r3)
            if (r5 == 0) goto La1
            r8 = 0
        L8f:
            int r9 = r5.size()
            ...
            com.magtek.mobile.android.mtcms.MTTLVObject r9 = (com.magtek.mobile.android.mtcms.MTTLVObject) r9
            r7.addTLVObject(r9)
            int r8 = r8 + 1
            goto L8f
        La1:
        ...
        Lb0:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.magtek.mobile.android.mtcms.MTTLVParser.parseTLVByteArray(byte[], boolean):java.util.List");
    }
}
