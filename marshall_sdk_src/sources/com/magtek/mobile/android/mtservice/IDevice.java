...
public interface IDevice extends IInterface {
    ...
    void setCallback(IDeviceCallback iDeviceCallback) throws RemoteException;

    public static abstract class Stub extends Binder implements IDevice {
        private static final String DESCRIPTOR = "com.magtek.mobile.android.mtservice.IDevice";
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                setCallback(IDeviceCallback.Stub.asInterface(parcel.readStrongBinder()));
        ...
        private static class Proxy implements IDevice {
            ...
            @Override // com.magtek.mobile.android.mtservice.IDevice
            public void setCallback(IDeviceCallback iDeviceCallback) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
                    parcelObtain.writeStrongBinder(iDeviceCallback != null ? iDeviceCallback.asBinder() : null);
