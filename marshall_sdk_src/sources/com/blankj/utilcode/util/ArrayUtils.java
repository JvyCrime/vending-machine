...
public class ArrayUtils {
    ...
    public static <T> T[] add(T[] tArr, T t) {
        ...
        T[] tArr2 = (T[]) ((Object[]) realAddOne(tArr, t, cls));
    ...
    private static Object realAddOne(Object obj, Object obj2, Class cls) {
        ...
        Objects.requireNonNull(objNewInstance, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.realAddOne() marked by @androidx.annotation.NonNull");
        return objNewInstance;
    }
    ...
    private static Object realAdd(Object obj, int i, Object obj2, Class cls) {
        if (obj == null) {
            ...
            Objects.requireNonNull(objNewInstance, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.realAdd() marked by @androidx.annotation.NonNull");
            return objNewInstance;
        }
        ...
        Objects.requireNonNull(objNewInstance2, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.realAdd() marked by @androidx.annotation.NonNull");
    ...
    private static Object remove(Object obj, int i) {
        ...
        Objects.requireNonNull(objNewInstance, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.remove() marked by @androidx.annotation.NonNull");
        return objNewInstance;
    }
    ...
    public static <T> List<T> asList(T... tArr) {
        if (tArr == null || tArr.length == 0) {
            ...
            Objects.requireNonNull(listEmptyList, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.asList() marked by @androidx.annotation.NonNull");
            return listEmptyList;
        }
        List<T> listAsList = Arrays.asList(tArr);
        Objects.requireNonNull(listAsList, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.asList() marked by @androidx.annotation.NonNull");
        return listAsList;
    }

    public static <T> List<T> asUnmodifiableList(T... tArr) {
        List<T> listUnmodifiableList = Collections.unmodifiableList(asList(tArr));
        Objects.requireNonNull(listUnmodifiableList, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.asUnmodifiableList() marked by @androidx.annotation.NonNull");
    ...
    public static String toString(Object obj) {
        ...
        if (obj instanceof Object[]) {
            ...
            Objects.requireNonNull(strDeepToString, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.toString() marked by @androidx.annotation.NonNull");
            return strDeepToString;
        }
        if (obj instanceof boolean[]) {
            String string = Arrays.toString((boolean[]) obj);
            Objects.requireNonNull(string, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.toString() marked by @androidx.annotation.NonNull");
            return string;
        }
        if (obj instanceof byte[]) {
            String string2 = Arrays.toString((byte[]) obj);
            Objects.requireNonNull(string2, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.toString() marked by @androidx.annotation.NonNull");
            return string2;
        }
        if (obj instanceof char[]) {
            String string3 = Arrays.toString((char[]) obj);
            Objects.requireNonNull(string3, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.toString() marked by @androidx.annotation.NonNull");
            return string3;
        }
        if (obj instanceof double[]) {
            String string4 = Arrays.toString((double[]) obj);
            Objects.requireNonNull(string4, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.toString() marked by @androidx.annotation.NonNull");
            return string4;
        }
        if (obj instanceof float[]) {
            String string5 = Arrays.toString((float[]) obj);
            Objects.requireNonNull(string5, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.toString() marked by @androidx.annotation.NonNull");
            return string5;
        }
        if (obj instanceof int[]) {
            String string6 = Arrays.toString((int[]) obj);
            Objects.requireNonNull(string6, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.toString() marked by @androidx.annotation.NonNull");
            return string6;
        }
        if (obj instanceof long[]) {
            String string7 = Arrays.toString((long[]) obj);
            Objects.requireNonNull(string7, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.toString() marked by @androidx.annotation.NonNull");
            return string7;
        }
        if (obj instanceof short[]) {
            String string8 = Arrays.toString((short[]) obj);
            Objects.requireNonNull(string8, "Detected an attempt to return null from a method com.blankj.utilcode.util.ArrayUtils.toString() marked by @androidx.annotation.NonNull");
            return string8;
        }
