...
public final class AppUtils {
    ...
    public static String getAppName(String str) {
        ...
        try {
            PackageManager packageManager = Utils.getApp().getPackageManager();
            PackageInfo packageInfo = packageManager.getPackageInfo(str, 0);
            String string = packageInfo == null ? "" : packageInfo.applicationInfo.loadLabel(packageManager).toString();
            if (string != null) {
                return string;
            }
    ...
    public static List<String> getAppSignaturesSHA256(String str) {
        List<String> appSignaturesHash = getAppSignaturesHash(str, SecurityProvider.ALG_DIGEST_SHA256);
    ...
    public static List<String> getAppSignaturesMD5(String str) {
        List<String> appSignaturesHash = getAppSignaturesHash(str, SecurityProvider.ALG_DIGEST_MD5);
