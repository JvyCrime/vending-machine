...
public final class EncryptUtils {
    ...
    public static byte[] encryptMD5(byte[] bArr) {
        return hashTemplate(bArr, SecurityProvider.ALG_DIGEST_MD5);
    }
    ...
    */
    ...
    public static byte[] encryptSHA224(byte[] bArr) {
        return hashTemplate(bArr, SecurityProvider.ALG_DIGEST_SHA224);
    }
    ...
    public static byte[] encryptHmacMD5(byte[] bArr, byte[] bArr2) {
        return hmacTemplate(bArr, bArr2, SecurityProvider.ALG_HMAC_MD5);
    }
    ...
    public static byte[] encryptHmacSHA384(byte[] bArr, byte[] bArr2) {
        return hmacTemplate(bArr, bArr2, SecurityProvider.ALG_HMAC_SHA384);
    }
    ...
    public static byte[] encryptHmacSHA512(byte[] bArr, byte[] bArr2) {
        return hmacTemplate(bArr, bArr2, SecurityProvider.ALG_HMAC_SHA512);
    }
    ...
    public static byte[] encryptAES(byte[] bArr, byte[] bArr2, String str, byte[] bArr3) {
        return symmetricTemplate(bArr, bArr2, SecurityProvider.ALG_KEYGEN_AES, str, bArr3, true);
    }
    ...
    public static byte[] decryptAES(byte[] bArr, byte[] bArr2, String str, byte[] bArr3) {
        return symmetricTemplate(bArr, bArr2, SecurityProvider.ALG_KEYGEN_AES, str, bArr3, false);
    }
