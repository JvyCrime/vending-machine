...
public class vmc_socket_t extends vmc_client_t {
            ...
            if (b2 == 0) {
                ...
                if (i2 == 2) {
                    ...
                    if (((marshall_t.msg_modem_status_t) msg_marshall_tVar.body).extra > 0) {
                        this.m_pending_tx_msg_timeout = r10.extra * 1000;
                    }
                }
            } else if (b2 == 5) {
                notify(4, null);
    ...
    */
    protected boolean handleMessage(com.bitmick.marshall.models.MsgObject r11) {
        /*
            Method dump skipped, instruction units count: 298
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bitmick.marshall.vmc.vmc_socket_t.handleMessage(com.bitmick.marshall.models.MsgObject):boolean");
    }
