...
public class CH34xSerialDevice extends UsbSerialDevice {
    ...
    private int init() {
        if (setControlCommandOut(FT_4222_Defines.CHIPTOP_CMD.CHIPTOP_SET_DS_CTL1_REG, 49820, 45753, null) < 0) {
            Log.i(CLASS_ID, "init failed! #1");
            return -1;
        }
        if (setControlCommandOut(FT_4222_Defines.CHIPTOP_CMD.CHIPTOP_SET_SR_CTL1_REG, 223, 0, null) < 0) {
            Log.i(CLASS_ID, "init failed! #2");
            return -1;
        }
        if (setControlCommandOut(FT_4222_Defines.CHIPTOP_CMD.CHIPTOP_SET_SR_CTL1_REG, 159, 0, null) < 0) {
        ...
        if (setControlCommandOut(CH341_REQ_WRITE_REG, 9496, 195, null) < 0) {
    ...
    private int writeHandshakeByte() {
        if (setControlCommandOut(FT_4222_Defines.CHIPTOP_CMD.CHIPTOP_SET_SR_CTL1_REG, ~((this.dtr ? 32 : 0) | (this.rts ? 64 : 0)), 0, null) >= 0) {
            return 0;
        }
    ...
    private int setControlCommandOut(int i, int i2, int i3, byte[] bArr) {
        int iControlTransfer = this.connection.controlTransfer(64, i, i2, i3, bArr, bArr != null ? bArr.length : 0, 5000);
    ...
    private int setControlCommandIn(int i, int i2, int i3, byte[] bArr) {
        int iControlTransfer = this.connection.controlTransfer(192, i, i2, i3, bArr, bArr != null ? bArr.length : 0, 5000);
        Log.i(CLASS_ID, "Control Transfer Response: " + String.valueOf(iControlTransfer));
        return iControlTransfer;
    }
