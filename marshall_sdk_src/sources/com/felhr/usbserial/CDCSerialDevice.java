...
public class CDCSerialDevice extends UsbSerialDevice {
    ...
    private int setControlCommand(int i, int i2, byte[] bArr) {
        int iControlTransfer = this.connection.controlTransfer(33, i, i2, 0, bArr, bArr != null ? bArr.length : 0, 5000);
    ...
    private byte[] getLineCoding() {
        ...
        int iControlTransfer = this.connection.controlTransfer(161, 33, 0, 0, bArr, 7, 5000);
        Log.i(CLASS_ID, "Control Transfer Response: " + String.valueOf(iControlTransfer));
        return bArr;
    }
