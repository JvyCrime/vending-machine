...
final class SchemaManager extends SQLiteOpenHelper {
    ...
    static {
        $$Lambda$SchemaManager$nhFFioRqpd7jp6fFHA2EofZ5bk __lambda_schemamanager_nhffiorqpd7jp6ffha2eofz5bk = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.-$$Lambda$SchemaManager$nhFFioRqpd7jp6fFHA2EofZ5-bk
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) {
                SchemaManager.lambda$static$0(sQLiteDatabase);
            }
        };
        MIGRATE_TO_V1 = __lambda_schemamanager_nhffiorqpd7jp6ffha2eofz5bk;
        $$Lambda$SchemaManager$EvhGxWlmpBVfuj3rXGCdvtKejmA __lambda_schemamanager_evhgxwlmpbvfuj3rxgcdvtkejma = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.-$$Lambda$SchemaManager$EvhGxWlmpBVfuj3rXGCdvtKejmA
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) {
                SchemaManager.lambda$static$1(sQLiteDatabase);
            }
        };
        MIGRATE_TO_V2 = __lambda_schemamanager_evhgxwlmpbvfuj3rxgcdvtkejma;
        $$Lambda$SchemaManager$XH3bHEgPsw1uBZYVhTMum4Uai4g __lambda_schemamanager_xh3bhegpsw1ubzyvhtmum4uai4g = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.-$$Lambda$SchemaManager$XH3bHEgPsw1uBZYVhTMum4Uai4g
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) {
                sQLiteDatabase.execSQL("ALTER TABLE events ADD COLUMN payload_encoding TEXT");
            }
        };
        MIGRATE_TO_V3 = __lambda_schemamanager_xh3bhegpsw1ubzyvhtmum4uai4g;
        $$Lambda$SchemaManager$aCl09xQlxj4356RjJu1WvPyjB4o __lambda_schemamanager_acl09xqlxj4356rjju1wvpyjb4o = new Migration() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.-$$Lambda$SchemaManager$aCl09xQlxj4356RjJu1WvPyjB4o
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SchemaManager.Migration
            public final void upgrade(SQLiteDatabase sQLiteDatabase) {
                SchemaManager.lambda$static$3(sQLiteDatabase);
            }
        };
        MIGRATE_TO_V4 = __lambda_schemamanager_acl09xqlxj4356rjju1wvpyjb4o;
        INCREMENTAL_MIGRATIONS = Arrays.asList(__lambda_schemamanager_nhffiorqpd7jp6ffha2eofz5bk, __lambda_schemamanager_evhgxwlmpbvfuj3rxgcdvtkejma, __lambda_schemamanager_xh3bhegpsw1ubzyvhtmum4uai4g, __lambda_schemamanager_acl09xqlxj4356rjju1wvpyjb4o);
    }
