...
public class JobInfoScheduler implements WorkScheduler {
    ...
    int getJobId(TransportContext transportContext) {
        ...
        adler32.update(this.context.getPackageName().getBytes(Charset.forName(UsbSerialDebugger.ENCODING)));
        adler32.update(transportContext.getBackendName().getBytes(Charset.forName(UsbSerialDebugger.ENCODING)));
