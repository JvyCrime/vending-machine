...
final class zzji extends zzii<Double> implements RandomAccess, zzkg, zzln {
    ...
    public final int hashCode() {
        int iZzc = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZzc = (iZzc * 31) + zzkh.zzc(Double.doubleToLongBits(this.zzb[i]));
        }
        return iZzc;
    }
    ...
    public final /* bridge */ /* synthetic */ zzkg zzd(int i) {
        if (i >= this.zzc) {
            return new zzji(Arrays.copyOf(this.zzb, i), this.zzc);
        }
    ...
    private zzji(double[] dArr, int i) {
        this.zzb = dArr;
        this.zzc = i;
    }
