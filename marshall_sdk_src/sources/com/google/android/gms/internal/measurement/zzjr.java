...
public enum zzjr {
    ...
    static {
        zzjr[] zzjrVarArrValues = values();
        zzZ = new zzjr[zzjrVarArrValues.length];
        for (zzjr zzjrVar : zzjrVarArrValues) {
            zzZ[zzjrVar.zzac] = zzjrVar;
        }
    }

    zzjr(int i, int i2, zzkk zzkkVar) {
        this.zzac = i;
        this.zzab = zzkkVar;
        zzkk zzkkVar2 = zzkk.VOID;
        int i3 = i2 - 1;
        if (i3 == 1 || i3 == 3) {
