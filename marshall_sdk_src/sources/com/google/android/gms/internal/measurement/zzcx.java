...
final class zzcx extends zzdt {
    ...
    public final void zza() {
        ...
        try {
            ...
            ((zzcc) Preconditions.checkNotNull(this.zze.zzj)).initialize(ObjectWrapper.wrap(this.zzc), new zzcl(43042L, Math.max(localVersion, r0), DynamiteModule.getRemoteVersion(this.zzc, ModuleDescriptor.MODULE_ID) < localVersion, str, str2, str3, this.zzd, com.google.android.gms.measurement.internal.zzfn.zza(this.zzc)), this.zzh);
        } catch (Exception e) {
