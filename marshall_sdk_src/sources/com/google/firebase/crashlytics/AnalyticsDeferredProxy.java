...
public class AnalyticsDeferredProxy {
    ...
    public BreadcrumbSource getDeferredBreadcrumbSource() {
        return new BreadcrumbSource() { // from class: com.google.firebase.crashlytics.-$$Lambda$AnalyticsDeferredProxy$r6YOZKphPGa7evPx_bIfwycOmMM
            @Override // com.google.firebase.crashlytics.internal.breadcrumbs.BreadcrumbSource
            public final void registerBreadcrumbHandler(BreadcrumbHandler breadcrumbHandler) {
                this.f$0.lambda$getDeferredBreadcrumbSource$0$AnalyticsDeferredProxy(breadcrumbHandler);
            }
        };
    }
    ...
    public AnalyticsEventLogger getAnalyticsEventLogger() {
        return new AnalyticsEventLogger() { // from class: com.google.firebase.crashlytics.-$$Lambda$AnalyticsDeferredProxy$coUGc_ajgUQ0irmwlH5XF0vy_0g
            @Override // com.google.firebase.crashlytics.internal.analytics.AnalyticsEventLogger
            public final void logEvent(String str, Bundle bundle) {
                this.f$0.lambda$getAnalyticsEventLogger$1$AnalyticsDeferredProxy(str, bundle);
            }
        };
    }
    ...
    private void init() {
        this.analyticsConnectorDeferred.whenAvailable(new Deferred.DeferredHandler() { // from class: com.google.firebase.crashlytics.-$$Lambda$AnalyticsDeferredProxy$La2k-FPhuF7YvsGTThH2cGQQb48
            @Override // com.google.firebase.inject.Deferred.DeferredHandler
            public final void handle(Provider provider) {
                this.f$0.lambda$init$2$AnalyticsDeferredProxy(provider);
            }
        });
    }
